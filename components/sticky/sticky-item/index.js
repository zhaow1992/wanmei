var _baseComponent = _interopRequireDefault(require("../helpers/baseComponent")), _classNames2 = _interopRequireDefault(require("../helpers/classNames"));
...
(0, _baseComponent.default)({
    ...
    methods: {
        onScroll: function onScroll(e) {
            var t = this.getRelationNodes("../sticky/index")[0], i = this.data, n = i.top, a = i.height, r = i.index, s = n <= e && e < n + a;
        ...
        updated: function updated(t) {
            var i = this, e = ".".concat(this.data.prefixCls);
