...
Page({
    ...
    onLoad: function onLoad(options) {
        ...
        this.queryMajorsHotRanking(options.isborz);
    },
    ...
    queryMajorsHotRanking: function queryMajorsHotRanking() {
        ...
        api.QueryMajorsHotRankingByPaging("Majors/QueryMajorsHotRankingByPaging", "POST", that.cityId, parseInt(that.isborz), 2, that.data.pn).then(function(res) {
            that.setData({
