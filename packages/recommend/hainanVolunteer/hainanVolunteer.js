...
// packages/recommend//hainanVolunteer/hainanVolunteer.js
var app = getApp();
...
Page({
    ...
    onShareAppMessage: function onShareAppMessage(res) {
        ...
        if (that.options && that.options.numId) {
            return {
                ...
                path: "/packages/recommend/hainanVolunteer/hainanVolunteer?numId=" + that.options.numId + "&share=true"
            };
        } else {}
    },
    //重新筛选院校列表
    ...
    majorDetail: function majorDetail(e) {
        ...
        wx.navigateTo({
            url: "/packages/selectMajor/majorDetail/majorDetail?majorcode=" + majorcode + "&cityid=853"
        });
    },
    ...
    getZyTable: function getZyTable() {
        var _this5 = this;
        var that = this;
        api.getBJZyTable("Users/ZyTable/HaiNan/Get", "POST", this.options.numId).then(function(res) {
    ...
    saveZyTable: function saveZyTable() {
        ...
        api.SaveBjTable("Users/ZyTable/HaiNan/Save ", "POST", data).then(function(res) {
            // if (that.options && that.options.numId) {
            // } else {
